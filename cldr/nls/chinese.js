...
//begin v1.x content
{
	...
	"dayPeriods-standAlone-narrow@localeAlias108": {
		"bundle": "gregorian",
		"target": "dayPeriods-standAlone-abbr"
	},
	"dateFormatItem-Hms": "HH:mm:ss",
	"dayPeriods-standAlone-narrow@localeAlias109": {
		"bundle": "gregorian",
	...
	"days-standAlone-short@localeAlias94": {
		"bundle": "gregorian",
		"target": "days-format-short"
	},
	"days-standAlone-short@localeAlias95": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"dateTimeFormats-appendItem-Timezone": "{0} {1}",
	"field-wed-narrow-relative+-1": "last Wednesday",
	"days-standAlone-short@localeAlias96": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"field-mon-short@localeAlias131": {
		"bundle": "",
		"target": "field-mon"
	},
	...
	"dayPeriods-format-narrow@localeAlias105": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	...
	"field-second-short@localeAlias155": {
		"bundle": "",
		"target": "field-second"
	},
	...
	"months-standAlone-wide@localeAlias86": {
		"bundle": "chinese",
		"target": "months-format-wide"
	},
	"field-minute-narrow": "Minute",
	"months-format-narrow@localeAlias83": {
		"bundle": "chinese",
		"target": "months-standAlone-narrow"
	},
	"field-tue-narrow@localeAlias135": {
		"bundle": "",
		"target": "field-tue-short"
	},
	"field-tue-narrow@localeAlias136": {
		"bundle": "",
		"target": "field-tue"
	},
	...
	"field-wed-short@localeAlias137": {
		"bundle": "",
		"target": "field-wed"
	},
	"field-week-narrow-relative+0": "this week",
	"field-second-narrow@localeAlias156": {
		"bundle": "",
		"target": "field-second-short"
	},
	"dayPeriods-standAlone-abbr@localeAlias107": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	"field-week-narrow-relative+1": "next week",
	"field-second-narrow@localeAlias157": {
		"bundle": "",
		"target": "field-second"
	},
	"timeFormat@localeAlias112": {
		"bundle": "gregorian",
		"target": "timeFormat"
	},
	...
	"quarters-standAlone-wide@localeAlias103": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"field-year-relative+0": "this year",
	"field-hour-short@localeAlias149": {
		"bundle": "",
		"target": "field-hour"
	},
	...
	"field-year-narrow@localeAlias114": {
		"bundle": "",
		"target": "field-year-short"
	},
	"field-year-narrow@localeAlias115": {
		"bundle": "",
		"target": "field-year"
	},
	"dateFormatItem-H": "HH",
	...
	"days-format-abbr@localeAlias88": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"months-format-abbr@localeAlias82": {
		"bundle": "chinese",
		"target": "months-format-wide"
	},
	...
	"field-day-short@localeAlias125": {
		"bundle": "",
		"target": "field-day"
	},
	"months-standAlone-abbr@localeAlias84": {
		"bundle": "chinese",
		"target": "months-format-abbr"
	},
	"months-standAlone-abbr@localeAlias85": {
		"bundle": "chinese",
		"target": "months-format-wide"
	},
	"field-second": "Second",
	"field-year-relative+-1": "last year",
	"field-month-short@localeAlias119": {
		"bundle": "",
		"target": "field-month"
	},
	...
	"field-mon-narrow@localeAlias132": {
		"bundle": "",
		"target": "field-mon-short"
	},
	"dateFormatItem-UM": "U MM",
	"field-mon-narrow@localeAlias133": {
		"bundle": "",
		"target": "field-mon"
	},
	"field-sun-narrow@localeAlias129": {
		"bundle": "",
	...
	"field-sun-narrow@localeAlias130": {
		"bundle": "",
		"target": "field-sun"
	},
	...
	"quarters@localeAlias98": {
		"bundle": "gregorian",
		"target": "quarters"
	},
	"field-second-relative+0": "now",
	"field-quarter-relative+-1": "last quarter",
	"days-format-short@localeAlias90": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-format-short@localeAlias91": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"field-hour": "Hour",
	"field-fri-short@localeAlias143": {
		"bundle": "",
		"target": "field-fri"
	},
	"field-hour-narrow@localeAlias150": {
		"bundle": "",
		"target": "field-hour-short"
	},
	"field-hour-narrow@localeAlias151": {
		"bundle": "",
		"target": "field-hour"
	},
	"field-week-narrow@localeAlias123": {
		"bundle": "",
		"target": "field-week-short"
	},
	"field-week-narrow@localeAlias124": {
		"bundle": "",
		"target": "field-week"
	},
	...
	"field-thu-narrow@localeAlias141": {
		"bundle": "",
		"target": "field-thu-short"
	},
	"field-thu-narrow@localeAlias142": {
		"bundle": "",
		"target": "field-thu"
	},
	...
	"days-standAlone-abbr@localeAlias92": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"field-tue-short-relative+-1": "last Tuesday",
	"days-standAlone-abbr@localeAlias93": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"quarters-standAlone-abbr@localeAlias101": {
		"bundle": "gregorian",
		"target": "quarters-format-abbr"
	},
	"quarters-standAlone-abbr@localeAlias102": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"months-format-abbr": [
	...
	"field-fri-narrow@localeAlias144": {
		"bundle": "",
		"target": "field-fri-short"
	},
	"field-fri-narrow@localeAlias145": {
		"bundle": "",
		"target": "field-fri"
	},
	...
	"dayPeriods-standAlone-wide@localeAlias110": {
		"bundle": "gregorian",
		"target": "dayPeriods-standAlone-abbr"
	},
	"dayPeriods-standAlone-wide@localeAlias111": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	"field-week-short@localeAlias122": {
		"bundle": "",
		"target": "field-week"
	},
	...
	"field-minute-narrow@localeAlias153": {
		"bundle": "",
		"target": "field-minute-short"
	},
	"field-minute-narrow@localeAlias154": {
		"bundle": "",
		"target": "field-minute"
	},
	...
	"field-sun-short@localeAlias128": {
		"bundle": "",
		"target": "field-sun"
	},
	...
	"field-quarter-short@localeAlias116": {
		"bundle": "",
	...
	"days-format-narrow@localeAlias89": {
		"bundle": "gregorian",
	...
	"field-quarter-narrow@localeAlias117": {
		"bundle": "",
		"target": "field-quarter-short"
	},
	"dateTimeFormat-long": "{1} {0}",
	"field-quarter-narrow@localeAlias118": {
		"bundle": "",
		"target": "field-quarter"
	},
	...
	"field-wed-narrow@localeAlias138": {
		"bundle": "",
		"target": "field-wed-short"
	},
	"dayPeriods-format-wide@localeAlias106": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	"field-wed-narrow@localeAlias139": {
		"bundle": "",
		"target": "field-wed"
	},
	...
	"quarters-format-abbr@localeAlias99": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"field-year-narrow-relative+0": "this year",
	"field-year-narrow-relative+1": "next year",
	"field-tue-short@localeAlias134": {
		"bundle": "",
		"target": "field-tue"
	},
	"dateFormatItem-Gy": "r U",
	"field-thu-short@localeAlias140": {
		"bundle": "",
		"target": "field-thu"
	},
	"field-minute-short@localeAlias152": {
		"bundle": "",
		"target": "field-minute"
	},
	...
	"field-day-narrow@localeAlias126": {
		"bundle": "",
		"target": "field-day-short"
	},
	"field-day-narrow@localeAlias127": {
		"bundle": "",
		"target": "field-day"
	},
	...
	"field-sat-narrow@localeAlias147": {
		"bundle": "",
		"target": "field-sat-short"
	},
	"field-sat-narrow@localeAlias148": {
		"bundle": "",
		"target": "field-sat"
	},
