...
//begin v1.x content
{
	...
	"field-sat-narrow@localeAlias555": {
		"bundle": "",
		"target": "field-sat-short"
	},
	"field-fri-narrow-relative+0": "this Friday",
	"field-sat-narrow@localeAlias556": {
		"bundle": "",
		"target": "field-sat"
	},
	...
	"days-standAlone-abbr@localeAlias498": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"field-minute-narrow": "Minute",
	"days-standAlone-abbr@localeAlias499": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"field-year-short@localeAlias521": {
		"bundle": "",
		"target": "field-year"
	},
	...
	"dayPeriods-format-narrow@localeAlias511": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	...
	"field-second-short@localeAlias563": {
		"bundle": "",
		"target": "field-second"
	},
	"field-month": "Month",
	...
	"field-tue-narrow@localeAlias543": {
		"bundle": "",
		"target": "field-tue-short"
	},
	"dateTimeFormats-appendItem-Second": "{0} ({2}: {1})",
	"field-tue-narrow@localeAlias544": {
		"bundle": "",
		"target": "field-tue"
	},
	"field-year-relative+0": "this year",
	"field-year-relative+1": "next year",
	"field-wed-short@localeAlias545": {
		"bundle": "",
		"target": "field-wed"
	},
	"dayPeriods-standAlone-abbr@localeAlias513": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	"quarters-standAlone-wide@localeAlias509": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"field-tue-relative+0": "this Tuesday",
	"field-second-narrow@localeAlias564": {
		"bundle": "",
		"target": "field-second-short"
	},
	"field-tue-relative+1": "next Tuesday",
	"field-second-narrow@localeAlias565": {
		"bundle": "",
		"target": "field-second"
	},
	"timeFormat@localeAlias520": {
		"bundle": "gregorian",
		"target": "timeFormat"
	},
	...
	"days-standAlone-wide@localeAlias503": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"dateTimeFormats-appendItem-Day": "{0} ({2}: {1})",
	"field-hour-short@localeAlias557": {
		"bundle": "",
		"target": "field-hour"
	},
	"field-tue-short-relative+0": "this Tuesday",
	"field-tue-short-relative+1": "next Tuesday",
	"days-format-short@localeAlias496": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"dateTimeFormats-appendItem-Year": "{1} {0}",
	"days-format-short@localeAlias497": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"quarters-format-narrow@localeAlias506": {
		"bundle": "gregorian",
		"target": "quarters-standAlone-narrow"
	},
	"field-year-narrow@localeAlias522": {
		"bundle": "",
		"target": "field-year-short"
	},
	"field-year-narrow@localeAlias523": {
		"bundle": "",
		"target": "field-year"
	},
	"field-month-narrow@localeAlias528": {
		"bundle": "",
		"target": "field-month-short"
	},
	"dateFormatItem-yyyyQQQ": "G y QQQ",
	"field-month-narrow@localeAlias529": {
		"bundle": "",
		"target": "field-month"
	},
	...
	"field-sat-short@localeAlias554": {
		"bundle": "",
		"target": "field-sat"
	},
	"days-standAlone-short@localeAlias500": {
		"bundle": "gregorian",
		"target": "days-format-short"
	},
	"days-standAlone-short@localeAlias501": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-standAlone-short@localeAlias502": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"months-standAlone-abbr@localeAlias490": {
		"bundle": "generic",
		"target": "months-format-abbr"
	},
	"months-standAlone-abbr@localeAlias491": {
		"bundle": "generic",
	...
	"field-day-short@localeAlias533": {
		"bundle": "",
		"target": "field-day"
	},
	"field-month-short@localeAlias527": {
		"bundle": "",
		"target": "field-month"
	},
	...
	"field-mon-narrow@localeAlias540": {
		"bundle": "",
		"target": "field-mon-short"
	},
	"field-mon-narrow@localeAlias541": {
		"bundle": "",
		"target": "field-mon"
	},
	"field-sun-narrow@localeAlias537": {
		"bundle": "",
		"target": "field-sun-short"
	},
	"field-sun-narrow@localeAlias538": {
		"bundle": "",
		"target": "field-sun"
	},
	...
	"field-hour": "Hour",
	"dayPeriods@localeAlias510": {
		"bundle": "gregorian",
		"target": "dayPeriods"
	},
	"days-format-abbr@localeAlias494": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"months-standAlone-wide@localeAlias492": {
		"bundle": "generic",
		"target": "months-format-wide"
	},
	...
	"field-hour-narrow@localeAlias558": {
		"bundle": "",
		"target": "field-hour-short"
	},
	"field-hour-narrow@localeAlias559": {
		"bundle": "",
		"target": "field-hour"
	},
	"dateFormatItem-yyyy": "G y",
	"months-format-abbr@localeAlias488": {
		"bundle": "generic",
		"target": "months-format-wide"
	},
	"dateTimeFormats-appendItem-Minute": "{0} ({2}: {1})",
	"field-fri-short@localeAlias551": {
		"bundle": "",
		"target": "field-fri"
	},
	"field-day": "Day",
	"field-thu-narrow@localeAlias549": {
		"bundle": "",
		"target": "field-thu-short"
	},
	"field-week-narrow@localeAlias531": {
		"bundle": "",
		"target": "field-week-short"
	},
	"field-week-narrow@localeAlias532": {
		"bundle": "",
		"target": "field-week"
	},
	...
	"quarters-standAlone-abbr@localeAlias507": {
		"bundle": "gregorian",
		"target": "quarters-format-abbr"
	},
	"quarters-standAlone-abbr@localeAlias508": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	...
	"dayPeriods-standAlone-wide@localeAlias516": {
		"bundle": "gregorian",
		"target": "dayPeriods-standAlone-abbr"
	},
	"dayPeriods-standAlone-wide@localeAlias517": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	...
	"field-fri-narrow@localeAlias552": {
		"bundle": "",
		"target": "field-fri-short"
	},
	"field-fri-narrow@localeAlias553": {
		"bundle": "",
		"target": "field-fri"
	},
	...
	"field-week-short@localeAlias530": {
		"bundle": "",
		"target": "field-week"
	},
	"days-format-narrow": [
	...
	"field-quarter-short@localeAlias524": {
		"bundle": "",
	...
	"field-quarter-narrow@localeAlias525": {
		"bundle": "",
		"target": "field-quarter-short"
	},
	"dateFormatItem-yyyyM": "GGGGG y-MM",
	"field-tue-relative+-1": "last Tuesday",
	"field-quarter-narrow@localeAlias526": {
		"bundle": "",
		"target": "field-quarter"
	},
	"field-minute-short": "Minute",
	"dayPeriods-format-wide@localeAlias512": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	"field-wed-narrow@localeAlias546": {
		"bundle": "",
		"target": "field-wed-short"
	},
	"field-wed-narrow@localeAlias547": {
		"bundle": "",
		"target": "field-wed"
	},
	"dateFormatItem-Hm": "HH:mm",
	"field-thu-short@localeAlias548": {
		"bundle": "",
		"target": "field-thu"
	},
	...
	"field-tue-short@localeAlias542": {
		"bundle": "",
		"target": "field-tue"
	},
	"field-minute-short@localeAlias560": {
		"bundle": "",
		"target": "field-minute"
	},
	...
	"field-day-narrow@localeAlias534": {
		"bundle": "",
		"target": "field-day-short"
	},
	"field-day-narrow@localeAlias535": {
		"bundle": "",
		"target": "field-day"
	}
}
