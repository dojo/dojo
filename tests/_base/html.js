...
if(dojo.isBrowser){
	...
	doh.registerUrl("tests._base.html", dojo.moduleUrl("tests", "_base/html_box.html"));
	doh.registerUrl("tests._base.html", dojo.moduleUrl("tests", "_base/html_box_quirks.html"));	
