define({
	...
	shape : function(/*String*/text, /*String*/shaperType, /*String?*/
			textDir) {
		// summary:
		...
		if (shaperType === "National") {
			...
			return this._shapeContextual(text, 2);  //default context is Arabic
		} else {
			return this._shapeContextual(text, 1);  // default context is English
		}
	},
	...
	_shapeContextual : function(/*String*/text, /*int*/context) {
		// summary:
		//		Converts the digits in the text to European or Arabic digits
		...
		for (var i = 0; i < text.length; ++i) {
			...
			if (c >= "0" && c <= "9") { // European digits range
				if (context === 2) { // context = 2 so convert from European to Arabic. else skip.
					textArr[i] = String.fromCharCode(parseInt(c) + 1632);
				}
			} else if (c >= "\u0660" && c <= "\u0669") { // Arabic digits range
				if (context === 1) { // context = 1 so convert from Arabic to European. else skip.
					textArr[i] = c.charCodeAt(0) - 1632;
				}
			} else { // this is not an Arabic or European digit.
				context = this._getContext(c, context);
			}
	...
	_getContext : function(/*String*/char, /*int*/oldContext) {
		// summary:
		//		Get the current context according to the type of the input char.
		//		If the char is strong Arabic, return 2
		//		Else if it is a strong English, return 1
		//		Otherwise return the oldContext.
		// char: String
		 ...
		 */
		var strongArabic = /[\u0608\u060B\u060D\u061B-\u064A\u066D-\u066F\u0671-\u06D5\u06E5-\u06E6\u06EE-\u06EF\u06FA-\u06FF\u0750-\u077F\u08A0-\u08E3\u200F\u202B\u202E\u2067\uFB50-\uFD3D\uFD40-\uFDCF\uFDF0-\uFDFC\uFDFE-\uFDFF\uFE70-\uFEFE]/;
		
		var weakArabic = /[\u0600-\u0607\u0609-\u060A\u060C\u060E-\u061A\u064B-\u066C\u0670\u06D6-\u06E4\u06E7-\u06ED\u06F0-\u06F9\u08E4-\u08FF\uFD3E-\uFD3F\uFDD0-\uFDEF\uFDFD\uFEFF ]/;
		 ...
		 */
		var weakLatin = /[\u0000-\u0040\u005B-\u0060\u007B-\u007F\u0080-\u00A9\u00AB-\u00B4\u00B6-\u00B9\u00BB-\u00BF\u00D7\u00F7\u02B9-\u02BA\u02C2-\u02CF\u02D2-\u02DF\u02E5-\u02ED\u02EF-\u02FF\u2070\u2074-\u207E\u2080-\u208E\u2100-\u2101\u2103-\u2106\u2108-\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A-\u213B\u2140-\u2144\u214A-\u214D\u2150-\u215F\u2189\uA720-\uA721\uA788\uFF01-\uFF20\uFF3B-\uFF40\uFF5B-\uFF65\uFFE0-\uFFE6\uFFE8-\uFFEE ]/;

		if (strongArabic.test(char)) {
			return 2;
		} else if (weakArabic.test(char) || weakLatin.test(char)) {
			return oldContext;
		} else {
			return 1;
		}
