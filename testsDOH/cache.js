define(["../main", "doh/main", "require", "../cache", "../_base/url"], function(dojo, doh, require){
	doh.register("testsDOH.cache", [{
			name: "dojo.cache",
			runTest: function(t){
				var expected = "<h1>Hello World</h1>";

				t.is(expected, dojo.trim(dojo.cache("dojo.testsDOH.cache", "regular.html")));
				t.is(expected, dojo.trim(dojo.cache("dojo.testsDOH.cache", "sanitized.html", {sanitize: true})));

				//Test object variant for module.
				var objPath = require.toUrl("dojo/testsDOH/cache/object.html");
				...
				t.is(null, dojo.cache("dojo.testsDOH.cache", "regular.html", null));

				//Set empty string as value
				t.is("", dojo.cache("dojo.testsDOH.cache", "regular.html", ""));
				t.is("", dojo.cache("dojo.testsDOH.cache", "regular.html"));
			}
		}
	]);
